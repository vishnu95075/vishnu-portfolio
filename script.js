...
let theme = localStorage.getItem("vishnu-portfolio-theme");

if (theme === null || theme === null) {
	localStorage.setItem("vishnu-portfolio-theme", "light-theme");
	theme = localStorage.getItem("vishnu-portfolio-theme");
...
toggleCheckbox.addEventListener("click", (e) => {
	if (e.target.checked) {
		localStorage.setItem("vishnu-portfolio-theme", "dark-theme");
		themeToggle.innerHTML = `<i class="fa-solid fa-sun"></i>`;
	} else {
		localStorage.setItem("vishnu-portfolio-theme", "light-theme");
		themeToggle.innerHTML = '<i class="fa-solid fa-moon"></i>';
